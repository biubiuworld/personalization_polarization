...
class GameInstruction(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['VhFhH10_game_payoff_list'] = []
...
class OpinionUpdate(Page):
   ...
   # timeout_seconds = 10
    ...
    def before_next_page(self):
        ...
        self.participant.vars['VhFhH10_game_payoff_list'].append(self.player.payoff)
        self.participant.vars['VhFhH10_game_payoff'] = random.choices(self.participant.vars['VhFhH10_game_payoff_list'])[0]

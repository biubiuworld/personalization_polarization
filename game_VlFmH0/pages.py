...
class GameInstruction(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['VlFmH0_game_payoff'] = 0.
...
class OpinionUpdate(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['VlFmH0_game_payoff'] = self.player.payoff
        self.player.game_payoff = self.participant.vars['VlFmH0_game_payoff']
class Results(Page):
    # def is_displayed(self):
...
class GamePayment(Page):
    ...
    def vars_for_template(self):
        return{
            'VlFmH0_game_payoff': self.participant.vars['VlFmH0_game_payoff'],
        }

...
class Subsession(BaseSubsession):
    def generate_initial_opinion(self):
        ...
        for p in self.get_players():
            ...
            p.initial_opinion = initial_opinion_set[
                p.id_in_group - 1]  # randomly pick one as initial opinion from initial opinion set
    ...
    def generate_observed_players_eachround(self):
        ...
        for p in self.get_players():
            ...
            p.observed_opinion_player1 = p.participant.vars['others_last_opinions'][
                p.participant.vars['others_id_in_group'].index(p.observed_id_player1)]
            p.observed_opinion_player2 = p.participant.vars['others_last_opinions'][
                p.participant.vars['others_id_in_group'].index(p.observed_id_player2)]
...
class Player(BasePlayer):
    ...
    disconnect_with_neighbor_1 = models.IntegerField(blank=True)
    disconnect_with_neighbor_2 = models.IntegerField(blank=True)
    disconnect_with_neighbor_3 = models.IntegerField(blank=True)
    disconnect_with_neighbor_4 = models.IntegerField(blank=True)
    disconnect_with_neighbor_5 = models.IntegerField(blank=True)
    disconnect_with_neighbor_6 = models.IntegerField(blank=True)

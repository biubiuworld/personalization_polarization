...
class Constants(BaseConstants):
    ...
    quiz_question_choices = [
        ...
        [[1, 'A. \( 150 - 0.9 * (50 - 40)^2 - 0.1 * (50 - 30)^2 \)'], [2, 'B. \( 150 - 0.9 * (30 - 40)^2 - 0.1 * (30 - 50)^2  \)'],
         [3, 'C. \( 150 - 0.9 * (30 - 42)^2 - 0.1 * (30 - 50)^2 \)'], [4, 'D. \( 150 - 0.9 * (50 - 42)^2 - 0.1 * (50 - 30)^2  \)']],  # q6
        [[1, 'A. \(  [150 - 0.9 * (40 - 50)^2 - 0.1 * (40 - 40)^2]+[150 - 0.9 * (30 - 30)^2 - 0.1 * (30 - 40)^2]  \)'],
         [2, 'B. \(  [150 - 0.9 * (30 - 40)^2 - 0.1 * (30 - 30)^2]+[150 - 0.9 * (30 - 50)^2 - 0.1 * (30 - 30)^2] \)'],
         [3, 'C. \(  [150 - 0.9 * (30 - 42)^2 - 0.1 * (30 - 30)^2]+[150 - 0.9 * (30 - 55)^2 - 0.1 * (30 - 30)^2] \)'],
         [4, 'D. \(  [150 - 0.9 * (30 - 42)^2 - 0.1 * (30 - 30)^2]+[150 - 0.9 * (30 - 50)^2 - 0.1 * (30 - 30)^2] \)']
         ],  # q7
    ]

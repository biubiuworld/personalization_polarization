...
class GameInstruction(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['FhH10_game_payoff'] = 0.
...
class GamePayment(Page):
    ...
    def vars_for_template(self):
        ...
        self.participant.vars['FhH10_game_payoff'] = max(random.choice(game_payoff_selection_list), 0)
        self.player.game_payoff = round(self.participant.vars['FhH10_game_payoff'])
        return{
            'FhH10_game_payoff': round(self.participant.vars['FhH10_game_payoff']),
        }
